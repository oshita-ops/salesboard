  ...
  const css = `
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .btn-accent {
      ...
      box-shadow: 0 2px 10px rgba(232,83,14,0.25);
    }
        ...
        <div className="page-landing">
          ...
          <div className="hero-section">
            ...
            <div className="hero-left">
              ...
              <h1 className="hero">
                営業フリーランスという働き方で
                <span className="accent-line"><span className="num">月100</span>万円以上</span>
                の収入が目指せる
              </h1>
          ...
          <div className="about-section">
            <div className="about-illo">
              <svg viewBox="0 0 400 340" xmlns="http://www.w3.org/2000/svg">
                {/* Background blob */}
                <ellipse cx="200" cy="200" rx="195" ry="160" fill="#FEF3C7" opacity="0.6"/>
                {/* Desk */}
                <rect x="40" y="270" width="320" height="12" rx="6" fill="#CBD5E1"/>
                {/* Monitor */}
                <rect x="130" y="140" width="160" height="120" rx="8" fill="#1E293B"/>
                <rect x="136" y="146" width="148" height="108" rx="4" fill="#EFF6FF"/>
                {/* Chart on monitor */}
                <rect x="148" y="220" width="18" height="28" rx="2" fill="#BFDBFE"/>
                <rect x="170" y="205" width="18" height="43" rx="2" fill="#3B82F6"/>
                <rect x="192" y="215" width="18" height="33" rx="2" fill="#93C5FD"/>
                <rect x="214" y="195" width="18" height="53" rx="2" fill="#1D4ED8"/>
                <rect x="236" y="208" width="18" height="40" rx="2" fill="#60A5FA"/>
                <polyline points="148,218 170,202 192,212 214,190 236,204 258,196" fill="none" stroke="#EF4444" strokeWidth="2" strokeLinecap="round"/>
                {/* Monitor stand */}
                <rect x="196" y="258" width="28" height="14" rx="2" fill="#64748B"/>
                <rect x="170" y="270" width="80" height="8" rx="4" fill="#94A3B8"/>
                {/* Person */}
                <circle cx="200" cy="100" r="28" fill="#FBBF80"/>
                <path d="M172 95 Q172 68 200 66 Q228 68 228 95" fill="#4338CA"/>
                {/* glasses */}
                <rect x="183" y="97" width="14" height="10" rx="5" fill="none" stroke="#1A1A2E" strokeWidth="2"/>
                <rect x="203" y="97" width="14" height="10" rx="5" fill="none" stroke="#1A1A2E" strokeWidth="2"/>
                <line x1="197" y1="102" x2="203" y2="102" stroke="#1A1A2E" strokeWidth="2"/>
                {/* body */}
                <rect x="174" y="128" width="52" height="70" rx="10" fill="#4338CA"/>
                {/* arm pointing */}
                <rect x="226" y="130" width="48" height="12" rx="6" fill="#FBBF80"/>
                <circle cx="278" cy="136" r="8" fill="#FBBF80"/>
                {/* left arm */}
                <rect x="140" y="148" width="36" height="11" rx="5" fill="#4338CA"/>
                {/* legs */}
                <rect x="178" y="196" width="19" height="52" rx="6" fill="#1D4ED8"/>
                <rect x="203" y="196" width="19" height="52" rx="6" fill="#1D4ED8"/>
                <rect x="175" y="242" width="26" height="12" rx="5" fill="#1A1A2E"/>
                <rect x="199" y="242" width="26" height="12" rx="5" fill="#1A1A2E"/>
                {/* floating data cards */}
                <rect x="20" y="120" width="95" height="52" rx="8" fill="white" stroke="#E2E8F0" strokeWidth="1.5"/>
                <circle cx="40" cy="140" r="10" fill="#DBEAFE"/>
                <text x="40" y="144" textAnchor="middle" fontSize="9" fill="#3B82F6" fontWeight="700">📊</text>
                <rect x="56" y="130" width="50" height="6" rx="3" fill="#E2E8F0"/>
                <rect x="56" y="140" width="38" height="6" rx="3" fill="#BFDBFE"/>
                <rect x="56" y="150" width="44" height="6" rx="3" fill="#E2E8F0"/>
                <rect x="295" y="100" width="88" height="50" rx="8" fill="white" stroke="#E2E8F0" strokeWidth="1.5"/>
                <text x="339" y="122" textAnchor="middle" fontSize="18">💰</text>
                <text x="339" y="140" textAnchor="middle" fontSize="11" fontWeight="700" fill="#10B981">+¥650,000</text>
              </svg>
            </div>
