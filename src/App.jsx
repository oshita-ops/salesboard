            ...
            <div className="admin-grid">
              ...
              <div className="admin-card">
                ...
                <div className="admin-form-row">
                  <label className="admin-label">案件タイトル *</label>
                  <input className="admin-input" placeholder="例：SaaS新規開拓営業" value={adminForm.title} onChange={e => setAdminForm({...adminForm, title: e.target.value})} />
                </div>
                <div className="admin-form-row">
                  <label className="admin-label">企業名 *</label>
                  <input className="admin-input" placeholder="例：株式会社〇〇" value={adminForm.company} onChange={e => setAdminForm({...adminForm, company: e.target.value})} />
                </div>
                <div className="admin-form-row">
                ...
                <div className="admin-form-row">
                  <label className="admin-label">報酬 *</label>
                  <input className="admin-input" placeholder="例：月60〜80万円" value={adminForm.rate} onChange={e => setAdminForm({...adminForm, rate: e.target.value})} />
                </div>
                <div className="admin-form-row">
                  <label className="admin-label">勤務地</label>
                  <input className="admin-input" placeholder="例：東京（一部リモート）" value={adminForm.location} onChange={e => setAdminForm({...adminForm, location: e.target.value})} />
                </div>
                <div className="admin-form-row">
                  <label className="admin-label">契約期間</label>
                  <input className="admin-input" placeholder="例：長期（6ヶ月〜）" value={adminForm.period} onChange={e => setAdminForm({...adminForm, period: e.target.value})} />
                </div>
                <div className="admin-form-row">
                  <label className="admin-label">タグ（カンマ区切り）</label>
                  <input className="admin-input" placeholder="例：SaaS, IT, 新規開拓" value={adminForm.tags} onChange={e => setAdminForm({...adminForm, tags: e.target.value})} />
                </div>
                <div className="admin-form-row">
                  <label className="admin-label">案件概要</label>
                  <textarea className="admin-textarea" placeholder="案件の詳細を入力..." value={adminForm.description} onChange={e => setAdminForm({...adminForm, description: e.target.value})} />
                </div>
                <div className="admin-form-row">
                  <label className="admin-label">応募要件</label>
                  <textarea className="admin-textarea" placeholder="必要なスキル・経験..." value={adminForm.requirements} onChange={e => setAdminForm({...adminForm, requirements: e.target.value})} />
                </div>
                <div className="admin-form-row">
                ...
                {editingJob && (
                  <button className="admin-btn secondary" onClick={resetAdminForm}>キャンセル</button>
                )}
              </div>
              ...
              <div className="admin-card">
                ...
                <div className="admin-job-list">
                  {jobs.length === 0 && (
                    <div style={{textAlign:'center',color:'var(--gray500)',padding:40}}>まだ案件がありません</div>
                  )}
                  {jobs.map(job => (
